...
//    10120211 - Arif Rachmat Darmawan - IF6
    ...
    private void dataInitializeDaily() {
        ...
        dailyHeading = new String[]{
                ...
                getString(R.string.nama_kegiatan6),

        };

        ImageResourceIDDaily = new int[]{
                R.drawable.daily_beres_beres,
                R.drawable.daily_coffe,
                R.drawable.daily_belajar,
                R.drawable.daily_reading,
                R.drawable.daily_code,
                R.drawable.daily_tidur,
